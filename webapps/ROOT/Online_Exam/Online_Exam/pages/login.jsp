      ...
      <div class="row justify-content-center">
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary border-0 mb-0">
            ...
            <div class="card-body px-lg-5 py-lg-5" style="height: 470px;">
              ...
              <form role="form">
                ...
                <div class="text-center" style="margin-top:56px;">
                  <input type="submit" name="email" value="Sign in" class="btn btn-primary my-4">
                  <!-- <a href="student_dashboard.html"><button type="button" class="btn btn-primary my-4">Sign in</button></a> -->
                </div>
              </form>
              <div class="row mt-7">
              <div class="col-6">
              ...
              <div class="col-6 text-right">
                <a href="regitration.jsp" class="text-light"><small>Create new account</small></a>
              </div>
              </div>
            </div>
          </div>          
