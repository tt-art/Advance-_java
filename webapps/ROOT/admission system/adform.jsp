alskdjfklajsldkfjkj<link href="//maxcdn.bootstrapcdn.com/bootstrap/3.3.0/css/bootstrap.min.css" rel="stylesheet" id="bootstrap-css">
...
String  a=request.getParameter("bt1");
if(a!=null)
 {
    try
    { 
